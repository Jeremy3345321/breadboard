...
public class InputToDB {
    ...
    public static class InputData {
        ...
        public InputData(int id, String name, String username, String circuitName, int section, int row, int column, int value) {
            this.id = id;
            this.name = name;
        ...
        public InputData(String name, String username, String circuitName, int section, int row, int column, int value) {
            this.name = name;
            this.username = username;
            this.circuitName = circuitName;
            this.section = section;
     ...
     */
    public boolean insertInput(String name, String username, String circuitName, Coordinate coord, int value) {
    ...
    /**
     * Update an existing input's value for a specific circuit
     */
    public boolean updateInputValue(String name, String username, String circuitName, int newValue) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        ContentValues values = new ContentValues();
